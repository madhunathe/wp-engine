...
if ( ! $checkout->is_registration_enabled() && $checkout->is_registration_required() && ! is_user_logged_in() ) {
	echo esc_html( apply_filters( 'woocommerce_checkout_must_be_logged_in_message', esc_html__( 'You must be logged in to checkout.', 'doccure' ) ) );
	return;
}
  ...
  <div class="row">
	...
	<div class="card">
 	...
 	<div class="card-header">
		<h4 class="card-title mt-0 mb-0"><?php esc_html_e( 'Your order', 'doccure' ); ?></h4>
    </div>
