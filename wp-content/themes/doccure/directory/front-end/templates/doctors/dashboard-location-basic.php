...
<div class="dc-location dc-tabsinfo">
	<div class="dc-tabscontenttitle mt-0">
		<h3><?php esc_html_e('Your Clinic Name', 'doccure'); ?></h3>
	</div>
	<div class="dc-formtheme dc-userform">
		<fieldset>
			<div class="form-group toolip-wrapo">
				<input type="text" name="location_title" class="form-control" value="<?php echo esc_attr($location_title); ?>" placeholder="<?php esc_attr_e('Your Clinic Name', 'doccure'); ?>">
				<?php do_action('doccure_get_tooltip','element','location_title');?>
			</div>
		</fieldset>
	</div>
</div>
<div class="dc-profilephoto dc-tabsinfo">
	<div class="dc-tabscontenttitle">
		<h3><?php esc_html_e('Clinic logo', 'doccure'); ?></h3>
	</div>
