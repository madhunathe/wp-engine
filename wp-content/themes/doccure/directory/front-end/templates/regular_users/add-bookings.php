...
$location_id	= get_post_meta($post_new, '_hospital_id', true);
 	...
 	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="dc-modalcontent modal-content">	
			<div class="dc-popuptitle">
				<h3><?php 
 				 esc_html_e('Reschedule Appointment','doccure');?></h3>
			...
			<div id="dcModalBody" class="modal-body dc-modal-content-one dc-haslayout">
				<div id="dcModalBody1" class="dc-visitingdoctor">
					<form class="dc-booking-doctor dc-formfeedback">
						...
						<input type="hidden" name="booking_hospitals" value="<?php echo $post->ID; ?>"  data-doctor_id="<?php echo intval( $post_id );?>" class="dc-booking-hospitals" >
