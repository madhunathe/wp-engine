...
<div class="col-xs-12 col-sm-12 col-md-12 col-lg-8 col-xl-9">		
	...
	<?php get_template_part('directory/front-end/templates/hospitals/dashboard', 'profile-settings-tabs'); ?>
		...
		<div class="dc-updatall">
			...
			<a class="dc-btn dc-update-gallery" data-id="<?php echo esc_attr( $user_identity ); ?>" data-post="<?php echo esc_attr( $post_id ); ?>" href="javascript:;"><?php esc_html_e('Save Changes', 'doccure'); ?></a>
		</div>	
	</form>		
</div>
